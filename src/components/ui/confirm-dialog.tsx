...
export function ConfirmDialog({
    ...
    const modal = (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 px-4 backdrop-blur-[2px] font-sans">
            ...
            <div className="relative flex w-158.75 min-h-[117.73px] flex-col justify-between rounded-[10.64px] border-[1.06px] border-[#D4D4D4] bg-white px-[21.27px] py-[14.89px] shadow-xl">
                {/* Title + Message */}
                <div className="text-left">
                    <h2 className="text-[15px] font-bold leading-tight text-[#111827]">{title}</h2>
