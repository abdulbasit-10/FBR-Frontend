...
import { RefreshCw, Plus, CheckSquare, Trash2, Download, ChevronLeft, ChevronRight, Building2 } from "lucide-react";
...
const MOCK_VENDORS: Vendor[] = [
    { id: 1, vendorNo: "V-000101", name: "PHARMA DISTRIBUTION CO.", province: "Punjab", type: "Company", registration: "Registered", ntn: "1234567", strn: "S-123456", source: "Manual" },
    { id: 2, vendorNo: "V-000100", name: "AL SHIFA SUPPLIERS", province: "Sindh", type: "Individual", registration: "Unregistered", ntn: "999999999", strn: "—", source: "Manual" },
    { id: 3, vendorNo: "V-000099", name: "MEDTECH IMPORTS PVT LTD", province: "Khyber Pakhtunkhwa", type: "Company", registration: "Registered", ntn: "7654321", strn: "S-654321", source: "API" },
    { id: 4, vendorNo: "V-000098", name: "BIOCARE TRADERS", province: "Balochistan", type: "AOP", registration: "Unregistered", ntn: "999999999", strn: "—", source: "Import" },
    { id: 5, vendorNo: "V-000097", name: "SUNRISE PHARMA PVTL LTD", province: "Punjab", type: "Company", registration: "Registered", ntn: "4521133", strn: "S-452113", source: "Manual" },
    { id: 6, vendorNo: "V-000096", name: "GREEN VALLEY MEDICINE", province: "Sindh", type: "Individual", registration: "Unregistered", ntn: "999999999", strn: "—", source: "Manual" },
    { id: 7, vendorNo: "V-000095", name: "HEALTH PLUS DISTRIBUTORS", province: "Punjab", type: "Company", registration: "Registered", ntn: "3312874", strn: "S-331287", source: "API" },
    { id: 8, vendorNo: "V-000094", name: "CITY MEDICAL STORES", province: "Islamabad", type: "Individual", registration: "Unregistered", ntn: "999999999", strn: "—", source: "Manual" },
];
...
const TABLE_COLS = ["Vendor No", "Name", "Province", "Type", "Registration", "NTN", "STRN", "Source", "Actions"];
...
export default function VendorsPage() {
    ...
    const filtered = vendors.filter((v) => {
        ...
        return (
            (!q || v.vendorNo.toLowerCase().includes(q) || v.name.toLowerCase().includes(q) || v.ntn.toLowerCase().includes(q) || v.strn.toLowerCase().includes(q)) &&
            (type === "All" || v.type === type) &&
            (registration === "All" || v.registration === registration) &&
    ...
    const regBadge = (r: Vendor["registration"]) => (
            ...
            <div className="rounded-[10px] border border-[#E5E7EB] dark:border-[#2e2e2e] bg-white dark:bg-[#242424] p-4 space-y-3">
                <div className="flex items-center gap-2 max-w-2xl">
                    <div className="flex-1">
                        <Input type="text" placeholder="Name, vendor no, NTN, STRN"
                            ...
                            {isLoading ? (
                                <tr>
                                    <td colSpan={TABLE_COLS.length + 1} className="py-10 text-center bg-white dark:bg-[#242424]">
                                        <LogoSpinner label="Loading Vendors..." className="mx-auto" />
                                    </td>
                                </tr>
                            ) : paginated.length === 0 ? (
                                <tr>
                                ...
                                paginated.map((v, i) => (
                                    <tr key={v.id} onClick={() => toggleSelect(v.id)}
                                        className={cn("cursor-pointer transition-colors hover:bg-[#FAF6F0] dark:hover:bg-[#2a2a2a]",
                                            selected.has(v.id) ? "bg-[#FDF3E3] dark:bg-[#3a2a10]" : i % 2 === 0 ? "bg-white dark:bg-[#242424]" : "bg-[#FAF6F0]/30 dark:bg-[#282828]"
                                        )}>
                                        ...
                                        <td className="px-3 py-2.5 text-[#4F5967] dark:text-[#9ca3af]">{v.source}</td>
