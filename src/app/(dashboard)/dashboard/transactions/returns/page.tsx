...
export default function SalesReturnPage() {
    ...
    const filtered = returns.filter((r) => {
        ...
        const matchesFrom = !dateFrom || r.docDate >= dateFrom;
        const matchesTo = !dateTo || r.docDate <= dateTo;
    ...
    const handleInvoiceSelect = (_inv: SaleInvoiceForReturn) => {
        // navigate to create return form with selected invoice pre-filled
    };
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            className="flex h-8 items-center gap-1.5 rounded-[5px] bg-[#C69A52] px-3 text-[12px] font-medium text-white hover:bg-[#b58b44] transition-colors"
                        >
                        ...
                        <button
                            ...
                            className="flex h-8 items-center gap-1.5 rounded-[5px] border border-[#E3D2BA] bg-white px-3 text-[12px] font-medium text-[#424B56] hover:bg-[#FAF6F0] transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                        >
                                ...
                                <tr>
                                    <td colSpan={TABLE_COLS.length + 1} className="py-14 text-center">
                                        <div className="flex flex-col items-center gap-2">
                                            <FileText className="h-8 w-8 text-[#C69A52] opacity-50" />
